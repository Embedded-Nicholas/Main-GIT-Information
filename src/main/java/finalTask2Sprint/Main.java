...
public class Main {
    public static void main(String[] args) {
        Map<String, List<Integer>> stateHolidays = new HashMap<>();

        // Заполняем данные о праздниках
        stateHolidays.put("Январь", Arrays.asList(1, 7));
        stateHolidays.put("Февраль", Collections.singletonList(23));
        stateHolidays.put("Март", Collections.singletonList(8));
        stateHolidays.put("Май", Arrays.asList(1, 9));
        stateHolidays.put("Июнь", Collections.singletonList(12));
        stateHolidays.put("Ноябрь", Collections.singletonList(4));
...
import java.util.*; // импортируйте нужные классы
        ...
        while (true) {
            ...
            if (command == 1) {
               ...
               ... // "Год основания " + keyGroup
                System.out.println(musicGroups.get(keyGroup));
